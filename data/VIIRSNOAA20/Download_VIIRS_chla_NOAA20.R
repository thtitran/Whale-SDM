...
output_dir <- "C:/github/Whale-SDM/data/VIIRSNOAA20"
...
input_dir <- "C:/github/Whale-SDM/data/VIIRSNOAA20"

input_files <- list.files(
  input_dir,
  pattern = "^NOAA20_VIIRS_chla_[0-9]{8}_[0-9]{8}\\.nc$",
  full.names = TRUE
)
...
output_file <- file.path(
  input_dir,
  "NOAA20_VIIRS_chla_20240331_20240731_combined.nc"
)

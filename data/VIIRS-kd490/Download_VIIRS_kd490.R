...
output_dir <- "C:/github/Whale-SDM/data/VIIRS-kd490"
...
input_dir <- "C:/github/Whale-SDM/data/VIIRS-kd490"

input_files <- list.files(
  input_dir,
  pattern = "^VIIRS_Kd490_[0-9]{8}_[0-9]{8}\\.nc$",
  full.names = TRUE
)
...
output_file <- file.path(
  input_dir,
  "VIIRS_Kd490_20240331_20240731_combined.nc"
)

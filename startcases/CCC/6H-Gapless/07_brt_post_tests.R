...
# Paths
# ------------------------------------------------------------
setwd("C:/github/Whale-SDM/startcases/CCC/6H-Gapless/BRT-output")

model_data_dir <- paste0("C:/github/Whale-SDM/", "startcases/CCC/6H-Gapless/Model-data")

bundle_file <- file.path(model_data_dir, "BRT-ready", "brt_model_data_bundle.rds")

brt_output_dir <- paste0("C:/github/Whale-SDM/", "startcases/CCC/6H-Gapless/BRT-output")
...
brt_output_dir <- "C:/github/Whale-SDM/startcases/CCC/6H-gapless/BRT-output"

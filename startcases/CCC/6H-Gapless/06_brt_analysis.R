...
brt_bundle <- readRDS("C:/github/Whale-SDM/startcases/CCC/6H-Gapless/Model-data/BRT-ready/brt_model_data_bundle.rds")
brt_static_data <- brt_bundle$data$static
static_predictors <- brt_bundle$predictors$static
...
#===================================
#Use this manually changed preset comparison for specific testing purposes
#===================================

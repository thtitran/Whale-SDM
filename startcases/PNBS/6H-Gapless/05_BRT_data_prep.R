...
master_file <- file.path("C:/github/Whale-SDM/startcases/PNBS/6H-Gapless/Model-data", "observed_crw_four_whales_static_dynamic_unfiltered.csv")
...
validation = paste0(
  "Leave-one-biological-whale-out folds; ",
  "all continuous track segments from the same biological whale ",

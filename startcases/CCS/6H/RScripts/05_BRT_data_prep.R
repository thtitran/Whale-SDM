...
master_file <- file.path("C:/github/Whale-SDM/startcases/CCS/6H/Model-data", "observed_crw_four_whales_static_dynamic_unfiltered.csv")
...
prepare_brt_data <- function(data, predictors, min_available = 10)
{
...
#create datasets
#start with around 10 min_avaiable, try up to 25-50ish
...
settings = list(minimum_available_per_choice = 10,

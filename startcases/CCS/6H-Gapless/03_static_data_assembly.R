...
#=================================
setwd("C:/github/Whale-SDM/startcases/CCS/6H-Gapless/Model-data")
crw_dir <- paste0("C:/github/Whale-SDM/", "startcases/CCS/6H/CRW")
...
#Crop to  extent covering all observed and CRW points
point_extent <- terra::ext(
  min(model_pts$long, na.rm = TRUE) - 0.25,
  max(model_pts$long, na.rm = TRUE) + 0.25,
  min(model_pts$lat, na.rm = TRUE) - 0.25,
  max(model_pts$lat, na.rm = TRUE) + 0.25
)
